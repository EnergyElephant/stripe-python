...
from stripe.test.helper import (
    StripeUnitTestCase, SAMPLE_WEBHOOK_PAYLOAD, SAMPLE_WEBHOOK_SECRET
)
...
class WebhookTests(StripeUnitTestCase):
    ...
    def test_create_event_from_payload(self):
        event = stripe.Webhook.create_event_from_payload(
...
class WebhookSignatureTests(StripeUnitTestCase):
    ...
    def generate_header(**kwargs):
        ...
        if signature is None:
            ...
            signature = stripe.WebhookSignature.compute_signature(
    ...
    def test_raise_on_timestamp_outside_tolerance(self):
        ...
        with self.assertRaisesRegexp(
            ...
            stripe.WebhookSignature.verify_header(
                SAMPLE_WEBHOOK_PAYLOAD, header, SAMPLE_WEBHOOK_SECRET, 10)
